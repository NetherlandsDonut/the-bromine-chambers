...
func print_stats_raw(race, background, just_first_page : bool = true, rounded : bool = true):
	...
	if just_first_page || not tab_swap:
		...
		set_cursor_x(1)
		modify_cursor_y(1)
		print_slot_raw("HEA", race, background)
		set_cursor_x(1)
		modify_cursor_y(1)
		print_slot_raw("CHE", race, background)
		set_cursor_x(1)
		modify_cursor_y(1)
		print_slot_raw("HAN", race, background)
		set_cursor_x(1)
		modify_cursor_y(1)
		print_slot_raw("LEG", race, background)
		set_cursor_xy(17, 16)
		write("Arms")
		modify_cursor_x(2)
		...
		set_cursor_x(17)
		modify_cursor_y(1)
		print_slot_raw("OFF", race, background)
		set_cursor_x(17)
		modify_cursor_y(1)
		print_slot_raw("RAN", race, background)
		set_cursor_xy(49, 16)
		write("Accessories")
		set_cursor_x(49)
		modify_cursor_y(2)
		print_accessory_raw(0, race, background)
		set_cursor_x(49)
		modify_cursor_y(1)
		print_accessory_raw(1, race, background)
		set_cursor_x(49)
		modify_cursor_y(1)
