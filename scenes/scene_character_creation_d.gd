...
static func draw_scene():
	globals.set_return_action(func():
		globals.set_scene("scene_character_creation_c", true)
	)
	globals.set_cursor_x(1)
	globals.write("Pick a name for your character", "Yellow")
	...
	globals.set_cursor_x(1)
	globals.modify_cursor_y(1)
	globals.write("● Male", "Cyan" if globals.character_creation_sex == "Male" else "LightGray")
	globals.set_cursor_x(1)
	globals.modify_cursor_y(1)
	globals.write("● Female", "Cyan" if globals.character_creation_sex == "Female" else "LightGray")
	globals.set_cursor_xy(17, 2)
	globals.write("Name : " + globals.character_creation_name)
	...
	globals.modify_cursor_y(1)
	globals.write_selectable(func():
		globals.character_creation_name = "Guwnos"
	)
	globals.write("Choose a custom name")
	globals.set_cursor_x(17)
	globals.modify_cursor_y(1)
	globals.write_selectable(func():
		globals.set_scene("scene_character_creation_e")
	)
