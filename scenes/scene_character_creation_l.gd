...
static func draw_scene():
	...
	globals.write("You have successfully created your character and your companion.", "Yellow")
	globals.set_cursor_x(1)
	globals.modify_cursor_y(1)
	globals.write("You are now fully prepared to embark on your quest.", "Yellow")
	globals.set_cursor_x(1)
	globals.modify_cursor_y(1)
	globals.write("On the last night before departing, you take a look at your", "Yellow")
	globals.set_cursor_x(1)
	globals.modify_cursor_y(1)
	globals.write("sleeping companion and consider your choices.", "Yellow")
